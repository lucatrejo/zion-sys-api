...
async function getAll() {
  const employees = await knex(TABLE_NAME)
    .select(knex.raw('id, name, last_name, cuil, identification, to_char(birthdate,\'MM/DD/YYYY\') as birthdate, address, to_char(admission_date,\'MM/DD/YYYY\') as admission_date'));
  return employees;
}
